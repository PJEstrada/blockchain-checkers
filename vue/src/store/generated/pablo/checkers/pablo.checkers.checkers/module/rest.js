...
export class Api extends HttpClient {
    constructor() {
         ...
         * @request GET:/pablo/checkers/checkers/canPlayMove
         */
        this.queryCanPlayMove = (query, params = {}) => this.request({
            path: `/pablo/checkers/checkers/canPlayMove`,
            method: "GET",
            query: query,
            format: "json",
            ...params,
         ...
         * @request GET:/pablo/checkers/checkers/leaderboard
         */
        this.queryLeaderboard = (params = {}) => this.request({
            path: `/pablo/checkers/checkers/leaderboard`,
            method: "GET",
            format: "json",
            ...params,
        });
         ...
         * @request GET:/pablo/checkers/checkers/nextGame
         */
        this.queryNextGame = (params = {}) => this.request({
            path: `/pablo/checkers/checkers/nextGame`,
            method: "GET",
            format: "json",
            ...params,
        });
         ...
         * @request GET:/pablo/checkers/checkers/playerInfo
         */
        this.queryPlayerInfoAll = (query, params = {}) => this.request({
            path: `/pablo/checkers/checkers/playerInfo`,
            method: "GET",
            query: query,
            format: "json",
            ...params,
         ...
         * @request GET:/pablo/checkers/checkers/playerInfo/{index}
         */
        this.queryPlayerInfo = (index, params = {}) => this.request({
            path: `/pablo/checkers/checkers/playerInfo/${index}`,
            method: "GET",
            format: "json",
            ...params,
        });
         ...
         * @request GET:/pablo/checkers/checkers/storedGame
         */
        this.queryStoredGameAll = (query, params = {}) => this.request({
            path: `/pablo/checkers/checkers/storedGame`,
            method: "GET",
            query: query,
            format: "json",
            ...params,
         ...
         * @request GET:/pablo/checkers/checkers/storedGame/{index}
         */
        this.queryStoredGame = (index, params = {}) => this.request({
            path: `/pablo/checkers/checkers/storedGame/${index}`,
            method: "GET",
            format: "json",
            ...params,
        });
