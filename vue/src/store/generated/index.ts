...
import PabloCheckersPabloCheckersCheckers from './pablo/checkers/pablo.checkers.checkers'
...
export default { 
  ...
  PabloCheckersPabloCheckersCheckers: load(PabloCheckersPabloCheckersCheckers, 'pablo.checkers.checkers'),
