...
export const MsgPlayMoveResponse = {
  ...
  fromJSON(object: any): MsgPlayMoveResponse {
    return {
      idValue: isSet(object.idValue) ? String(object.idValue) : "",
      capturedX: isSet(object.capturedX)
        ? Long.fromString(object.capturedX)
        : Long.ZERO,
      capturedY: isSet(object.capturedY)
        ? Long.fromString(object.capturedY)
        : Long.ZERO,
  ...
  toJSON(message: MsgPlayMoveResponse): unknown {
    ...
    message.capturedX !== undefined &&
      (obj.capturedX = (message.capturedX || Long.ZERO).toString());
    message.capturedY !== undefined &&
      (obj.capturedY = (message.capturedY || Long.ZERO).toString());
